-- 1. Функция для просмотра истории объекта
...
BEGIN
    RETURN QUERY EXECUTE format('
        SELECT
            ...
            to_jsonb(t) - ''id'' - ''time_create'' - ''time_dead'' AS details
        FROM %I t
        WHERE id = %s
...
-- 2. Функция для получения состояния таблицы на момент времени
...
-- 3. Функция для восстановления версии объекта
...
-- 4. Функция для сравнения версий объекта
